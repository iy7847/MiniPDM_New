-- ==============================================================================
-- 수주번호(order_number/po_no) 전역 유니크 제약조건 제거 및 회사별 복합 유니크 제약조건 적용
-- Multi-tenant 격리: 각 회사마다 고유하게 PYYMM-XXX 번호를 사용할 수 있도록 개선
-- ==============================================================================

-- 1. 기존 전역 단일 UNIQUE 제약조건 제거
...
-- 3. convert_estimate_to_order RPC 함수 업데이트 (회사별 채번 충돌 방어 강화)
